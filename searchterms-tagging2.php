...
function RCT12_stt2_admin_activation(){
	...
	$plugin_settings = array( 'max' => RCT12_MAX_SEARCH_TERMS, 'auto_add' => RCT12_AUTO_ADD, 'auto_link' => RCT12_AUTO_LINK,
...
function RCT12_stt2_admin_print_header(){
	...
	?>
		...
		<a href="http://wordpress.org/extend/plugins/recent-search-terms/" target="_blank">WordPress.org</a>.</p></div>
						...
						<form id="stt2-options" method="post" action="">
							<table class="stt2-table">
								<tr>
									...
									<td>
										<input type="checkbox" <?php if( 1 == get_option('RCT12_stt2_enabled') ){ echo 'checked'; }; ?> value="1" name="enabled"/>
									</td>
								</tr>
								<tr>
									<td width="350px">
								...
								<tr>
									...
									<td>
										<Input type="radio" name="auto_tag" value="1" <?php if ( 1 == get_option('RCT12_stt2_auto_tag') ){ echo 'checked'; } ;?> />         Yes&nbsp;&nbsp;
										<Input type="radio" name="auto_tag" value="0" <?php if ( 0 == get_option('RCT12_stt2_auto_tag') ){ echo 'checked'; } ;?> />         No
									</td>
								</tr>
								<tr>
									<td>
  ...
  <div class="metabox-holder">
       <div id="stt2-copyright" class="postbox">
        <div class="inside">
		  ...
		  <p>Copyright &copy; 2010-2011 by webspace.technology Original writer : Purwedi Kurniawan.</p> </div>
        </div>
     </div>
  </div>
</div>
...
function RCT12_stt2_register_2($form_name='frm2',$name,$email) {
	...
	?>
	 ...
	 <table width="640" cellspacing="1" style="border:1px solid #e9e9e9; padding: 0 14px 14px;">
	  ...
	  <tr><td>&nbsp;</td></tr>
	  <tr><td><?php RCT12_stt2_registration_form($form_name.'_0','Verify and Activate',$name,$email,$hide=1,$activate_again=1);?></td></tr>
	  <tr><td>&nbsp;</td></tr>
	 </table>
	 <p>&nbsp;</p>
	 <table width="640" cellspacing="1" style="border:1px solid #e9e9e9; padding: 0 14px 14px;">
	   ...
	   <tr><td>&nbsp;</td></tr>
	   <tr><td><?php RCT12_stt2_registration_form($form_name,'Register Again',$name,$email,$hide=0,$activate_again=2);?></td></tr>
	   <tr><td>&nbsp;</td></tr>
	   ...
	   <tr><td>&nbsp;</td></tr>
	   <tr><td>5. If you still got problems, please <a href="http://www.webspace.technology/" target="_blank">contact us</a></strong> about it and we will get to you ASAP.</td></tr>
	 </table>
	 </center>		
	<p>&nbsp;</p>
	</div>
...
function RCT12_stt2_register_1($form_name='frm1') {
	...
	?>
	 ...
	 <table width="620" cellpadding="10" cellspacing="1" bgcolor="#ffffff" style="border:1px solid #e9e9e9; padding: 0 14px 14px;">
	  ...
	  <tr><td>&nbsp;</td></tr>
	  <tr><td align="center"><?php RCT12_stt2_registration_form($form_name,'Register',$name,$email);?></td></tr>
	  <tr><td>&nbsp;</td></tr>
