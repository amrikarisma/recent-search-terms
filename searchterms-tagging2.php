			...
			if (isset($_POST['submit'])) {
				...
				<?php } else { ?>
					<div id="message" class="updated fade" style='background-color:#f66;'>
						<p>Recent search terms database! </p>
					</div>
	<?php }
...
function KRS_STG_stt2_admin_print_header()
{
	...
	?>
		<div>
			<p> If you think this plugin useful, please consider making a
				<a href="<?php echo $baseurl . '&donate'; ?>">donation</a> or write a review about it or at least give it a good rating on
				<a href="http://wordpress.org/extend/plugins/recent-search-terms/" target="_blank">WordPress.org</a>.
			</p>
		</div>
		<p><a href="<?php echo $baseurl; ?>">Settings</a> | <a href="<?php echo get_bloginfo('url') . '/wp-admin/widgets.php'; ?>">Widgets</a> | <a href="<?php echo $baseurl . '&stt2_help=1'; ?>">Help</a> | <strong>More Stats:</strong> <a href="<?php echo $baseurl . '&stats=1&count=50'; ?>">50</a>,
			...
			<a href="<?php echo $baseurl . '&stats=1&count=500'; ?>">500</a> | <strong>
				<a href="<?php echo $baseurl . '&stt2_no_traffics=0'; ?>">Posts Without Any Traffic from Search Engines</a></strong> ( <a href="<?php echo $baseurl . '&stt2_no_traffics=1'; ?>">URL Only</a> )
		</p>
		<?php
	}
	/*
			...
			<div class="metabox-holder">
				<div class="meta-box-sortables ui-sortable">
					<div id="stt2settings" class="postbox">
						...
						<h3 class="hndle">
							<span>General Settings ( Widgets has it own settings )</span>
						</h3>
						<div class="inside">
							<form id="stt2-options" method="post" action="">
								<table class="stt2-table">
									...
									<tr>
										...
										<td>
											<Input type="radio" name="auto_link" value="1" <?php if (1 == $options['auto_link']) {
																								echo 'checked';
																							}; ?> /> Yes, link to post content<br />
											<Input type="radio" name="auto_link" value="2" <?php if (2 == $options['auto_link']) {
																								echo 'checked';
																							}; ?> /> Yes, link to search page ( Not Recommended )<br />
											<Input type="radio" name="auto_link" value="0" <?php if (0 == $options['auto_link']) {
																								echo 'checked';
																							}; ?> /> No
										</td>
									</tr>
									<tr>
										...
										<td>
											<Input type="radio" name="show_count" value="1" <?php if (1 == $options['show_count']) {
																								echo 'checked';
																							}; ?> /> Yes&nbsp;&nbsp;
											<Input type="radio" name="show_count" value="0" <?php if (0 == $options['show_count']) {
																								echo 'checked';
																							}; ?> /> No
										</td>
									</tr>
									<tr>
										...
										<td>
											<Input type="radio" name="auto_add" value="1" <?php if (1 == $options['auto_add']) {
																								echo 'checked';
																							}; ?> /> Yes&nbsp;&nbsp;
											<Input type="radio" name="auto_add" value="0" <?php if (0 == $options['auto_add']) {
																								echo 'checked';
																							}; ?> /> No
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<Input type="radio" name="promote_old_post" value="1" <?php if (1 == $promote_old_post) {
																										echo 'checked';
																									}; ?> /> Yes&nbsp;&nbsp;
											<Input type="radio" name="promote_old_post" value="0" <?php if (0 == $promote_old_post) {
																										echo 'checked';
																									}; ?> /> No
										</td>
									</tr>
					...
					<div id="stt2-cleanup" class="postbox">
						...
						<h3 class="hndle">
							<span>Auto Clean Up Unused Search Terms:</span>
						</h3>
						<div class="inside">
							<p>
					...
					<div id="stt2-promote-post" class="postbox">
						...
						<h3 class="hndle">
							<span>Promote Post With No Search Engine Traffic</span>
						</h3>
						<div class="inside">
							<p>
							<ul style="margin: 0pt 0pt 14px 30px; list-style-type: circle;">
				...
				<div id="stt2-copyright" class="postbox">
					<div class="inside">
						<div class="frame" style="text-align:center">
							<p><strong>Recommended SEO Resources: <a href="http://www.webspace.technology" target="_blank">Webspace Technology</a></strong></p>
							<p>Copyright &copy; 2010-2011 by webspace.technology Original writer : Purwedi Kurniawan.</p>
						</div>
					</div>
				</div>
			</div>
...
<?php }
	...
	/**
	 * == DATABASE SECTION ==
	 * all main database related functions of recent search terms plugin
	 **/
	/**
	...
	/**
	 * == MAIN SECTION ==
	 * all main functions of recent search terms plugin
	 **/
	/**
...
?>
	...
	<table align="<?php echo $align_tbl; ?>">
		...
		<form name="nothankyou" method="post" action="<?php echo $nothankyou_url; ?>">
			<tr>
				<td>&nbsp;</td>
				<td><input class="button" type="submit" name="nothankyou" value="No Thank You!" /></td>
			</tr>
		</form>
	</table>
<?php
...
?>
	<center>
		<table width="640" cellspacing="1" style="border:1px solid #e9e9e9; padding: 0 14px 14px;">
			...
			<tr>
				<td>A confirmation email has been sent to your email "<?php echo $email; ?>". You must click on the confirmation link inside the email to register the plugin.</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>The confirmation email will look like this:<br /><img src="http://exclusivewp.com/wp-content/uploads/2010/08/email-confirmation.gif" style="margin-top:10px;border:0;" /></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
		...
		<table width="640" cellspacing="1" style="border:1px solid #e9e9e9; padding: 0 14px 14px;">
			...
			<tr>
				<td>1. I can't found the confirmation email in my inbox.<br />Please check your spam or bulk folder.</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>2. It's not there in the junk folder either.<br />In a rare case, it took times to arrive. Please wait for 6 hours at most. If after 6 hours and still no confirmation email, please register again using the form below:</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
			...
			<tr>
				<td>3. Still no confirmation email and I have already registered twice.<br />Using the form above, try to register again using DIFFERENT EMAIL ADDRESS.</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>4. I receive an error like this:<br />
					<img src="http://exclusivewp.com/wp-content/uploads/2010/08/email-confirmation-error.gif" style="margin-top:10px;border:0;" /><br />
					<br />This error means that you have already subscribed but have not yet clicked on the link inside confirmation email. In order to avoid any spam complain we don't send repeated confirmation emails.
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			...
			<tr>
				<td>5. If you still got problems, please <a href="http://www.webspace.technology/" target="_blank">contact us</a></strong> about it and we will get to you ASAP.</td>
			</tr>
		</table>
	</center>
	<p>&nbsp;</p>
...
?>
	<center>
		<table width="620" cellpadding="10" cellspacing="1" bgcolor="#ffffff" style="border:1px solid #e9e9e9; padding: 0 14px 14px;">
			...
			<tr>
				<td align="left">Registration is <strong>Free</strong> and only has to be done once. If you've register before or don't want to register, please click "No Thank You!" button.</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td align="left">In addition, you'll receive complimentary subscription to our Email Newsletter which will give you many news and tips about SEO. Of course, you can unsubscribe any time you want.</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
			...
			<tr>
				<td align="left">Disclaimer: Your contact information will be handled with the strictest confidence and will never be sold or shared with third parties.</td>
				</td>
			</tr>
		</table>
	</center>
		...
		<div class="metabox-holder">
			<div class="meta-box-sortables ui-sortable">
				<div id="popular-search-terms" class="postbox">
					...
					<h3 class="hndle">
						<span>100 Posts Without Any Traffic from Search Engines: </span>
					</h3>
					<div class="inside">
						<div class="frame list">
						...
						<div class="frame">
							<ol>
								...
								<li> I prefer to display the search terms in the form of paragraphs, separated by commas, not in the form of a list like the plugin default format. How can I get results like that?
									<p>* Go to 'WordPress Admin &gt; Settings &gt; Recent search terms' menu,
		...
		<div class="metabox-holder">
			<div class="meta-box-sortables ui-sortable">
				<div id="upgrade_db" class="postbox">
					...
					<div class="inside">
						<form method="post">
							<p>This upgrade will update your current database structure to gain better performance and lower server resources. Backup of your current database will be available on <strong><?php global $wpdb;
																																																			echo $wpdb->prefix . 'stt2_meta_backup'; ?></strong> table.</p>
...
?>
	<div style="text-align:center;">
		<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
			...
			<input name="business" value="nichom14@gmail.com" type="hidden" />
			<input name="item_name" value="Donation for Recent Search Terms Plugin" type="hidden" />
