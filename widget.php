...
{
  wp_register_sidebar_widget( 'widget_popular_terms_1', 'Popular Search Terms', 'widget_popular_terms',
  array(              // options
        'description' => 'Popular Search Terms'
    ));
  wp_register_widget_control( 'popular_terms_control_1', 'Popular Search Terms', 'popular_terms_control',   
  array(              // options
        'description' => 'Popular Search Terms'
    ) );    
}
...
{
  wp_register_sidebar_widget( 'widget_popular_terms_1', 'Recent Search Terms', 'widget_recent_terms',
  array(              // options
        'description' => 'Recent Search Terms'
    ));
  wp_register_widget_control( 'popular_terms_control_1', 'Recent Search Terms', 'recent_terms_control',   
  array(              // options
        'description' => 'Recent Search Terms'
    ) );    
}
...
{
  wp_register_sidebar_widget( 'widget_popular_terms_cat_1', 'Popular Terms in Category', 'widget_popular_terms_cat',
  array(              // options
        'description' => 'Popular Terms in Category'
    ));
  wp_register_widget_control( 'popular_terms_cat_control_1', 'Popular Terms in Category', 'popular_terms_cat_control',   
  array(              // options
        'description' => 'Popular Terms in Category'
    ) );    
}
...
{
  wp_register_sidebar_widget( 'RCT12_widget_random_terms_1', 'Random Search Terms', 'RCT12_widget_random_terms',
  array(              // options
        'description' => 'Random Search Terms'
    ));
  wp_register_widget_control( 'RCT12_random_terms_control_1', 'Random Search Terms', 'RCT12_random_terms_control',   
  array(              // options
        'description' => 'Random Search Terms'
    ) );    
}
