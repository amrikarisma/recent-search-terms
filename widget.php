...
?>
  ...
  <ul>
    <li><Input type="radio" name="popularterms-widgetlist" value="1" <?php if ($options['list'] == 1) {
                                                                        echo 'checked';
                                                                      }; ?> /> List</li>
    <li><Input type="radio" name="popularterms-widgetlist" value="0" <?php if ($options['list'] == 0) {
                                                                        echo 'checked';
                                                                      }; ?> /> Comma separated value</li>
  </ul>
  </p>
  <p>
    <label>Link to search (not recommended):</label>
    <Input type="radio" name="popularterms-widgetsearch" value="0" <?php if ($options['search'] == 0) {
                                                                      echo 'checked';
                                                                    }; ?> />No&nbsp;&nbsp;
    <Input type="radio" name="popularterms-widgetsearch" value="1" <?php if ($options['search'] == 1) {
                                                                      echo 'checked';
                                                                    }; ?> />Yes
  </p>
  <p>
...
?>
  ...
  <p>
    <label>Display format:</label>
  <ul>
    <li><Input type="radio" name="recentterms-widgetlist" value="1" <?php if ($options['list'] == 1) {
                                                                      echo 'checked';
                                                                    }; ?> /> List </li>
    <li><Input type="radio" name="recentterms-widgetlist" value="0" <?php if ($options['list'] == 0) {
                                                                      echo 'checked';
                                                                    }; ?> /> Comma separated value</li>
  </ul>
  </p>
  <p>
    <label>Link to search (not recommended):</label>
    <Input type="radio" name="recentterms-widgetsearch" value="0" <?php if ($options['search'] == 0) {
                                                                    echo 'checked';
                                                                  }; ?> />No&nbsp;&nbsp;
    <Input type="radio" name="recentterms-widgetsearch" value="1" <?php if ($options['search'] == 1) {
                                                                    echo 'checked';
                                                                  }; ?> />Yes
  </p>
  <p>
...
?>
  ...
  <p>
    <label>Display format:</label>
  <ul>
    <li><Input type="radio" name="populartermscat-widgetlist" value="1" <?php if ($options['list'] == 1) {
                                                                          echo 'checked';
                                                                        }; ?> /> List</li>
    <li><Input type="radio" name="populartermscat-widgetlist" value="0" <?php if ($options['list'] == 0) {
                                                                          echo 'checked';
                                                                        }; ?> /> Comma separated value</li>
  </ul>
  </p>
  <p>
    <label>Link to search (not recommended):</label>
    <Input type="radio" name="populartermscat-widgetsearch" value="0" <?php if ($options['search'] == 0) {
                                                                        echo 'checked';
                                                                      }; ?> />No&nbsp;&nbsp;
    <Input type="radio" name="populartermscat-widgetsearch" value="1" <?php if ($options['search'] == 1) {
                                                                        echo 'checked';
                                                                      }; ?> />Yes
  </p>
  <p>
...
?>
  ...
  <p>
    <label>Display format:</label>
  <ul>
    <li><Input type="radio" name="randomterms-widgetlist" value="1" <?php if ($options['list'] == 1) {
                                                                      echo 'checked';
                                                                    }; ?> /> List</li>
    <li><Input type="radio" name="randomterms-widgetlist" value="0" <?php if ($options['list'] == 0) {
                                                                      echo 'checked';
                                                                    }; ?> /> Comma separated value</li>
  </ul>
  </p>
  <p>
    <label>Link to search (not recommended):</label>
    <Input type="radio" name="randomterms-widgetsearch" value="0" <?php if ($options['search'] == 0) {
                                                                    echo 'checked';
                                                                  }; ?> />No&nbsp;&nbsp;
    <Input type="radio" name="randomterms-widgetsearch" value="1" <?php if ($options['search'] == 1) {
                                                                    echo 'checked';
                                                                  }; ?> />Yes
  </p>
  <p>
